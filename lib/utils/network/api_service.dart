...
class ApiService {
  ...
  // 查询充电实时数据
  static Future<Map<String, dynamic>> getChargeRealtime(String chargeConnectorId) {
    return _httpManager.get(
  ...
  static Future<Map<String, dynamic>> getChargeRecordsByDate({
    ...
    return _httpManager.post(
      ...
      data: {
        'chargeConnectorId': chargeConnectorId,
        'queryDate': queryDate,
      },
    );
  }
