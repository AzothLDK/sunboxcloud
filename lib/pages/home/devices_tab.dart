...
class _DevicesTabState extends State<DevicesTab> {
  ...
  // 选中的标签
  String _selectedTab = 'Charts';
  // 能量统计时间范围
  String _energyTimeRange = 'Week';
  // 能量统计日期
  String _energyDate = 'Mar 2 - 8';
  // 月份能量统计日期
  String _monthlyDate = 'Mar 2026';
                    ...
                    "series": [
                      {
                        ...
                        "type": "bar",
                        "data": [5.2, 6.1, 5.8, 6.5, 7.2, 6.8, 6.3],
                        "itemStyle": {"color": "#ff9800"},
                      },
                    ],
                  }),
                    ...
                    'series': [
                      {
                        'name': 'Supply',
                        'type': 'bar',
                        'data': [6.2, 6.8, 7.1, 6.9, 7.3, 7.0, 6.8],
                        'itemStyle': {'color': '#4caf50'},
                      },
                      {
                        'name': 'Consumption',
                        'type': 'bar',
                        'data': [6.0, 6.5, 6.8, 6.7, 7.0, 6.8, 6.5],
                        'itemStyle': {'color': '#2196f3'},
                      },
                    ],
                  }),
